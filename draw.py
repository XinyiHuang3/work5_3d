...
def generate_sphere( points, cx, cy, cz, r, step ):
    ...
    for i in range (step):
        for j in range (int(step/2) +1):
            ...
            theta = j * 2 * math.pi /step
            #print i 
            #print j 
            #print phi 
            #print theta
            x = r * math.cos(theta) + cx
            y = r * math.sin(theta) * math.sin(phi) + cy
            z = r * math.sin(theta) * math.cos(phi) + cz
...
def add_sphere( points, cx, cy, cz, r, step ):
    ...
    for element in sphere:
        add_edge(points, element[0], element[1], element[2], element[0]+1, element[1], element[2])
...
def generate_torus( points, cx, cy, cz, r0, r1, step ):
  ...
  # ====================
  # adds all the point spheres for a torus with center
